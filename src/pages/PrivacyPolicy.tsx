    ...
    >
      ...
      <div className="max-w-3xl w-full relative z-10">
        ...
        <div className="glass-card p-6 md:p-8 border border-white/5 flex flex-col gap-6 text-xs md:text-sm text-eco-muted leading-relaxed text-left">
          <div>
            <h3 className="text-white font-bold text-sm font-outfit mb-2">
              1. Information We Collect
            </h3>
            <p>
              EcoTrace collects data strictly to compute your estimated carbon footprint and track
              your daily sustainable savings. This information includes:
            </p>
            <ul className="list-disc list-inside mt-2 flex flex-col gap-1 pl-2 font-medium">
              ...
              <li>
                Footprint details: Transportation mileage, airline flight logs, home utility bills,
                diet preferences, and recycling rates.
              </li>
              <li>
                Daily Logs: Logged activities (such as using public transit or eating plant-based
                meals) and timestamps.
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p>
              Your privacy is our highest priority. All metrics, carbon calculator states, and logs
              are handled as follows:
            </p>
            <ul className="list-disc list-inside mt-2 flex flex-col gap-1 pl-2 font-medium">
              <li>
                <strong>Local Storage:</strong> By default, data is securely stored within your
                local browser cache (LocalStorage) so that no credentials or inputs are exposed to
                third-party databases.
              </li>
              <li>
                <strong>Cloud Sync:</strong> If you register and authenticate using Firebase, your
                data is synchronized securely with a private Firestore Database. Access is
                restricted using strict authorization rules (only authenticated users can read or
          ...
          <div>
            ...
            <p className="mt-3">
              We never sell, rent, or trade user data. All processing occurs locally or within your
              dedicated Firebase environment.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              You maintain full ownership of your data. You can delete your browser storage at any
              time to remove all logs. Registered users can contact administrator portals or clear
              their dashboard databases to permanently remove cloud records.
            </p>
          </div>
        </div>
