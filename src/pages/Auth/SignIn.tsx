...
const SignIn: React.FC = () => {
  const { signIn, error, clearError, signInWithGoogle } = useAuth();
        ...
        <div className="glass-card p-8 border border-white/5">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <button
              ...
              className="mt-2 w-full py-3.5 bg-eco-green hover:bg-eco-emerald disabled:bg-eco-green/50 text-white font-outfit font-bold rounded-xl shadow-lg shadow-eco-green/10 transition-all flex items-center justify-center cursor-pointer"
            >
              {isSubmitting ? (
            ...
            <div className="relative my-2 flex items-center justify-center">
              ...
              <span className="relative px-3 bg-[#111e17] text-[10px] uppercase font-bold text-eco-muted font-outfit">Or Continue With</span>
            </div>
